      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        ...
        <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {STEPS.map((step, i) => (
            ...
            >
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-b from-[#41e59b] to-[#25b374] font-mono text-sm font-semibold text-accent-on shadow-[0_4px_16px_rgba(56,214,142,0.25)]">
                {i + 1}
              </div>
